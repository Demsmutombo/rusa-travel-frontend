            ...
            <ul class="space-y-1">
              <li>
                <router-link
                  ...
                  :class="isActive('/manager/dashboard') 
              ...
              <li>
                <router-link
                  ...
                  class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors"
                  :class="isActive('/manager/performance') 
                    ? 'bg-blue-50 text-blue-600' 
                    : 'text-gray-700 hover:bg-gray-50'"
                >
                  <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <router-link
                  to="/manager/reports"
                  class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors"
                  :class="isActive('/manager/reports') 
                    ? 'bg-blue-50 text-blue-600' 
                    : 'text-gray-700 hover:bg-gray-50'"
                >
                  <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <router-link
                  to="/manager/settings"
                  class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors"
                  :class="isActive('/manager/settings') 
                    ? 'bg-blue-50 text-blue-600' 
                    : 'text-gray-700 hover:bg-gray-50'"
                >
                  <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const pageTitle = computed(() => {
  if (route.path === '/manager/dashboard') return 'Dashboard'
  if (route.path === '/manager/teams') return 'Équipes'
  if (route.path === '/manager/performance') return 'Performance'
  if (route.path === '/manager/reports') return 'Rapports'
  if (route.path === '/manager/settings') return 'Paramètres'
  return 'Manager'
})
