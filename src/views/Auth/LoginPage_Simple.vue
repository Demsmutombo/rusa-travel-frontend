  ...
  <div class="min-h-screen bg-white flex items-center justify-center px-4">
    <div class="max-w-md w-full">
      ...
      <div class="text-center mb-8">
        ...
        <p class="mt-2 text-sm text-gray-600">Documentation Simple</p>
      </div>
      ...
      <div class="bg-white py-8 px-6 shadow-lg rounded-lg border border-gray-200">
        ...
        <div class="mt-4 bg-yellow-50 border border-yellow-200 rounded-lg p-3">
          <p class="text-yellow-800 text-sm">
            <strong>Debug:</strong> Cliquez sur le bouton pour afficher la documentation
          </p>
        </div>
      </div>
...
<script>
// Pas de script setup pour éviter les erreurs TypeScript
console.log('LoginPage_Simple chargé - Version sans TypeScript')
</script>
