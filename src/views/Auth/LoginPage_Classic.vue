  ...
  <div class="min-h-screen bg-white flex items-center justify-center px-4">
    <div class="max-w-md w-full">
      ...
      <div class="text-center mb-8">
        ...
        <p class="mt-2 text-sm text-gray-600">Documentation Classic</p>
      </div>
      ...
      <div class="bg-white py-8 px-6 shadow-lg rounded-lg border border-gray-200">
        ...
        >
          ...
          {{ showDoc ? 'Masquer' : 'Voir' }} la Documentation
        </button>
      ...
      <div v-show="showDoc" class="mt-8 bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-8">
        <div class="bg-white rounded-lg p-6">
          ...
          <div class="bg-green-50 border-l-4 border-green-500 p-4 mb-4">
            <p class="text-green-800">
              <strong>Succès :</strong> Le bouton "Voir la Documentation" fonctionne avec Vue classique !
            </p>
          </div>
...
export default {
  ...
  methods: {
    toggleDocumentation() {
      ...
      console.log('Documentation togglée:', this.showDoc)
    }
  },
  mounted() {
    console.log('LoginPage_Classic monté - Vue classique')
  }
}
</script>
