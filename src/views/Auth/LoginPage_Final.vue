  ...
  <div class="min-h-screen bg-white flex items-center justify-center px-4">
    <div class="max-w-md w-full">
      ...
      <div class="text-center mb-8">
        ...
        <p class="mt-2 text-sm text-gray-600">Documentation de la plateforme</p>
      </div>

      <!-- Documentation Button -->
      <div class="bg-white py-8 px-6 shadow-lg rounded-lg border border-gray-200">
        <button
          onclick="window.showDoc = !window.showDoc; this.nextElementSibling.nextElementSibling.style.display = window.showDoc ? 'block' : 'none'; this.nextElementSibling.querySelector('strong').textContent = 'Debug: showDoc = ' + window.showDoc;"
        ...
        <div class="mt-4 bg-yellow-50 border border-yellow-200 rounded-lg p-3">
          <p class="text-yellow-800 text-sm">
            <strong>Debug: showDoc = false</strong>
          </p>
        </div>
      </div>

      <!-- Documentation Section -->
      <div style="display: none;" class="mt-8 bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-8">
        <div class="bg-white rounded-lg p-6">
          ...
          <div class="bg-green-50 border-l-4 border-green-500 p-4 mb-4">
            <p class="text-green-800">
              <strong>Succès :</strong> Le bouton "Voir la Documentation" fonctionne avec JavaScript pur !
            </p>
          </div>
          ...
          <button
            onclick="window.showDoc = false; this.parentElement.parentElement.style.display = 'none'; document.querySelector('.bg-yellow-50 strong').textContent = 'Debug: showDoc = false';"
...
if (typeof window !== 'undefined') {
  (window as any).showDoc = false
}

console.log('LoginPage_Final chargé avec JavaScript pur')
</script>
